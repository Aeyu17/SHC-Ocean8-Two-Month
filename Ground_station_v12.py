...
class GSSidebar(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        # self.debugToggle.setAlignment(QtCore.Qt.AlignCenter)
...
class CanvasWrapper(QtCore.QObject):
    ...
    def __init__(self, parent):
        ...
        # self.rot_grid.add_widget(rot_title, row=0, col=0, col_span=2)

        # # NOT IMPLEMENTED FLAG
        # not_implemented_label = scene.Label("[NOT IMPLEMENTED]", color='white')
        # not_implemented_label.height_max = SIZE_MAX
        # self.rot_grid.add_widget(not_implemented_label, row=1, col=0, col_span=2)
    ...
    def generateData(self):
        ...
        while True:
            ...
            try:
                ...
                ID, missionTime, packetCount, swState, plState, alt, temp, voltage = packet.split(",")
                ...
                writer.writerow([ID, missionTime, packetCount, swState, plState, alt, temp, voltage])
